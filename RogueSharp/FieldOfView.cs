...
namespace RogueSharp
{
   ...
   public class FieldOfView<TCell> where TCell : ICell
   {
      ...
      public FieldOfView<TCell> Clone()
      {
         ...
         return new FieldOfView<TCell>( _map, inFovCopy );
      }
      ...
      /// Exists Cells within the FOV would be what the character could see from their current location and lighting conditions
      /// </example>
      ...
      /// Field-of-view (FOV) is basically a calculation of what is observable in the Map from a given Cell with a given light radius.
      /// Exists existing field-of-view calculations will be overwritten when calling this method.
      /// </summary>
